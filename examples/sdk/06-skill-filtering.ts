...
import { createAgentSession, createSyntheticSourceInfo, DefaultResourceLoader, SessionManager } from "@mariozechner/pi-coding-agent";
...
async function main() {
  ...
  const loader = new DefaultResourceLoader({
    skillsOverride: (current) => {
      ...
      console.log("Filtered skills:", filtered.map((s) => s.name));
